...
per_contact_avgs %>%
  ggplot() + 
  geom_histogram(aes(x= transaction_count)) +
...
p1 <- per_contact_avgs %>%
  ggplot() + 
  geom_histogram(aes(x= log(total_sales_amount))) +
...
p1 <- data %>%
  ...
  ggplot(aes(x= purchase_year_month)) + 
    geom_point(aes(y = sales)) +
    geom_line(aes(y = sales), group=1) +
...
p2 <- data %>%
  ...
  ggplot(aes(x= purchase_year_month)) + 
    geom_point(aes(y = transaction_count), color = "red") +
    geom_line(aes(y = transaction_count), color = "red", group=1)
...
p3 <- data %>%
  ...
  ggplot(aes(x= purchase_year_month)) + 
    geom_point(aes(y = avg_sales_amount), color = "blue") +
    geom_line(aes(y = avg_sales_amount), color = "blue", group=1)

...
plotlist <- list()
i = 1
for(var in names(df_for_prediction)[c(-1,-2)][1:2]) {
...
```{r, echo = FALSE}
p_model4 <- fun_plot_model_eval("Random Forest - 1000 trees", rf_fit_full, rf_fit_just_returning, data_test, avg_sales_2012)
```

...
set.seed(93)
glmnet_fit_full <- train(as.formula(paste("total_sales_2013", paste(predictor_names, collapse="+"), sep="~")),
                   method = "glmnet",
                   data = data_train,
                   trControl = train_control,
                   tuneGrid = tune_grid,
...
set.seed(93)
glmnet_fit_just_returning  <- train(as.formula(paste("total_sales_2013", paste(predictor_names, collapse="+"), sep="~")),
                    method = "glmnet",
                   data = data_train_just_returning,
                   trControl = train_control,
                   tuneGrid = tune_grid,
